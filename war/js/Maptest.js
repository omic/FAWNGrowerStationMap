...
function createInfoBox(stnObj) {
    ...
    if (stnObj.type == "GROWER") {
        ...
        currentStation=stnObj;
        /*
        weatherInfor.innerHTML='<span>Station Name:'+stnObj.getStationTitle()+'</span></br></br>'
        	                  +'<span>Station ID: '+stnObj.stnID+'</span></br></br>'
                              +'<span>Lat: '+stnObj.lat+'</span></br></br>'
                              +'<span>Lon: '+stnObj.lng+'</span></br></br>'
                              +'<span>Temperature: '+stnObj.temper+'&degF</span></br></br>'
                              +'<span>Total Rain*: '+stnObj.getTotalRain()+'"</span></br></br>'
                              +'<span>Wind Speed '+stnObj.getWindSpeed()+'MPH</span></br></br>'
                              +'<span>Wind Direction: '+stnObj.wind_direction+'&deg</span></br></br>'
                              +'<span>Humidity: '+stnObj.humidity+'%</span></br></br>'
                              +'<span>Wet Bulb Temperature: '+stnObj.wet_bulb_temp+'&degF</span></br></br>'
                              +'<span>Rain: '+stnObj.getRain()+'"</span></br></br>'
                              +'<span>Date Time: '+stnObj.getDateTime()+'</span></br></br>';*/
